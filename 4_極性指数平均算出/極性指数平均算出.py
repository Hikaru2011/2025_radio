...
df = pd.read_excel(r"c:\Users\hikar\Desktop\内容分析プロジェクト\timeline_polarity.xlsx")
df_output = pd.read_csv(r"C:\Users\hikar\Desktop\exel分析\output.csv")
...
df_output.to_csv(r"c:\Users\hikar\Desktop\exel分析\output.csv")
print("処理終了")